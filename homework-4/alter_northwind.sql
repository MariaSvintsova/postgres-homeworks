...
ADD CONSTRAINT check_products_unit_price CHECK (unit_price > 0));

-- 2. Добавить ограничение, что поле discontinued таблицы products может содержать только значения 0 или 1
ALTER TABLE products (
ADD CONSTRAINT check_products_discontinued CHECK ( discontinued in (0, 1));
...
ALTER TABLE discontinued_products (ADD CONSTRAINT check_discontinued CHECK ( discontinued = 1);
